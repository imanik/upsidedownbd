...
if (choices) {
  choices.forEach(function (item, index) {
    ...
    if ("removeItemButton" in choice.dataset) {
      params.removeItemButton = choice.dataset.removeItemButton == "true";
    }

    if ("shouldSort" in choice.dataset) {
      params.shouldSort = choice.dataset.shouldSort == "true";
    } // console.log(params);


    new Choices(choice, params);
  });
}
...
__webpack_require__(/*! ./components/select */ "./resources/js/components/select.js");
})();
