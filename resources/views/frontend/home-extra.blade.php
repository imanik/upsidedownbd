...
<div class="g-bg-color--orange">
    <div class="container g-padding-y-80--xs g-padding-y-125--sm">
        <div class="g-text-center--xs g-margin-b-100--xs">
            ...
            <h2 class="g-font-size-32--xs g-font-size-36--sm g-color--white">Buy Online Ticket</h2>
        </div>
        <ul class="list-inline row g-margin-b-100--xs">
            ...
            <li class="col-sm-3 col-xs-6 g-full-width--xs s-process-v1 g-margin-b-60--xs g-margin-b-0--md">
                <div class="center-block g-text-center--xs">
                    ...
                    <div class="g-padding-x-20--xs">
                        <h3 class="g-font-size-18--xs g-color--white">Choose Your Day</h3>
            ...
            <li class="col-sm-3 col-xs-6 g-full-width--xs s-process-v1 g-margin-b-60--xs g-margin-b-0--md">
                <div class="center-block g-text-center--xs">
                    ...
                    <div class="g-padding-x-20--xs">
                        <h3 class="g-font-size-18--xs g-color--white">Choose Your Time</h3>
                        <p class="g-color--white-opacity"></p>
                    </div>
                </div>
            </li>
            ...
            <li class="col-sm-3 col-xs-6 g-full-width--xs s-process-v1 g-margin-b-60--xs g-margin-b-0--sm">
                <div class="center-block g-text-center--xs">
                    ...
                    <div class="g-padding-x-20--xs">
                        <h3 class="g-font-size-18--xs g-color--white">Pay Online</h3>
                        <p class="g-color--white-opacity"></p>
                    </div>
                </div>
            </li>
            ...
            <li class="col-sm-3 col-xs-6 g-full-width--xs s-process-v1">
                <div class="center-block g-text-center--xs">
                    ...
                    <div class="g-padding-x-20--xs">
                        <h3 class="g-font-size-18--xs g-color--white">Get Your Ticket</h3>
                        <p class="g-color--white-opacity"></p>
                    </div>
                </div>
            </li>
        ...
        <div class="g-text-center--xs">
            <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">
                <a href="#js__scroll-to-appointment" class="text-uppercase s-btn s-btn--md s-btn--white-bg g-radius--50">Buy Ticket</a>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="g-position--overlay g-padding-x-30--xs g-padding-y-30--xs g-margin-t-o-60--xs">
                        ...
                        <div class="g-text-center--xs">
                            <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">
                                    ...
                                    <a href="#" class="text-uppercase s-btn s-btn--xs s-btn--dark-brd g-radius--50">Photos</a>
                                    <a href="#" class="text-uppercase s-btn s-btn--xs s-btn--dark-brd g-radius--50">Buy Ticket</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="g-position--overlay g-padding-x-30--xs g-padding-y-30--xs g-margin-t-o-60--xs  ">
                        ...
                        <div class="g-text-center--xs ">
                            <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">
                                ...
                                <a href="{{url('/gallery')}}" class="text-uppercase s-btn s-btn--xs s-btn--dark-brd g-radius--50">Buy Ticket</a>
                            </div>
                        </div>
                    </div>
...
<div class="container-fluid g-padding-y-80--xs g-padding-y-125--sm">
    ...
    <div class="s-swiper js__swiper-news">
        ...
        <div class="swiper-wrapper g-margin-b-60--xs">
            <article class="s-promo-block-v4 g-bg-position--center swiper-slide" style="background: url({{ asset('assets/img/400x500/1.jpg')}})">
            ...
            <article class="s-promo-block-v4 g-bg-position--center swiper-slide" style="background:  url({{ asset('assets/img/400x500/2.jpg')}})">
                <div class="g-text-center--xs g-padding-x-15--xs g-padding-x-30--lg g-padding-y-50--xs g-margin-t-120--xs">
                    <div class="g-margin-b-25--xs">
                        <h3 class="g-font-size-16--xs g-color--white g-margin-b-5--xs">Our Services</h3>
                        <p class="g-color--white">Clinics can be privately operated.</p>
                    </div>
                    <a href="#" class="text-uppercase s-btn s-btn--xs s-btn--white-brd g-radius--50">Read More</a>
                </div>
            </article>
            <article class="s-promo-block-v4 g-bg-position--center swiper-slide" style="background: url({{ asset('assets/img/400x500/3.jpg')}})">
                <div class="g-text-center--xs g-padding-x-15--xs g-padding-x-30--lg g-padding-y-50--xs g-margin-t-120--xs">
                    <div class="g-margin-b-25--xs">
                        <h3 class="g-font-size-16--xs g-color--white g-margin-b-5--xs">Medical Services</h3>
                        <p class="g-color--white">Clinics can be privately operated.</p>
            ...
            <article class="s-promo-block-v4 g-bg-position--center swiper-slide" style="background: url({{ asset('assets/img/400x500/4.jpg')}})">
                <div class="g-text-center--xs g-padding-x-15--xs g-padding-x-30--lg g-padding-y-50--xs g-margin-t-120--xs">
                    <div class="g-margin-b-25--xs">
                        <h3 class="g-font-size-16--xs g-color--white g-margin-b-5--xs">Medical Services</h3>
                        <p class="g-color--white">Clinics can be privately operated.</p>
            ...
            <article class="s-promo-block-v4 g-bg-position--center swiper-slide" style="background: url({{ asset('assets/img/400x500/5.jpg')}})">
                <div class="g-text-center--xs g-padding-x-15--xs g-padding-x-30--lg g-padding-y-50--xs g-margin-t-120--xs">
                    <div class="g-margin-b-25--xs">
                        <h3 class="g-font-size-16--xs g-color--white g-margin-b-5--xs">Medical Services</h3>
                        <p class="g-color--white">Clinics can be privately operated.</p>
            ...
            <article class="s-promo-block-v4 g-bg-position--center swiper-slide" style="background: url({{ asset('assets/img/400x500/6.jpg')}})">
                <div class="g-text-center--xs g-padding-x-15--xs g-padding-x-30--lg g-padding-y-50--xs g-margin-t-120--xs">
                    <div class="g-margin-b-25--xs">
                        <h3 class="g-font-size-16--xs g-color--white g-margin-b-5--xs">Anik Services</h3>
                        <p class="g-color--white">Clinics can be privately operated.</p>
                    </div>
                    <a href="#" class="text-uppercase s-btn s-btn--xs s-btn--white-brd g-radius--50">Read More</a>
                </div>
        ...
        <div class="col-sm-4">
            <div class="g-text-center--xs g-padding-x-30--xs g-padding-x-50--lg g-padding-y-70--xs">
                ...
                <ul class="list-unstyled g-ul-li-tb-3--xs">
                    ...
                    <li><a href="">11am To 10pm</a></li>
                    <li><a href="">For Pre Booking</a></li>
                    <li><a href="">Lalmatia 01615710070</a></li>
                    <li><a href="">Uttara 018812882881</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container g-padding-y-80--xs g-padding-y-125--sm">
        ...
        <div class="row">
            <div class="col-md-3 col-xs-6 g-full-width--xs g-margin-b-70--xs g-margin-b-0--lg">
                <div class="g-text-center--xs">
                    <div class="g-margin-b-10--xs">
                        <figure class="g-display-inline-block--xs g-font-size-70--xs g-font-family--playfair g-color--white js__counter">30000</figure>
            ...
            <div class="col-md-3 col-xs-6 g-full-width--xs g-margin-b-70--xs g-margin-b-0--sm">
                <div class="g-text-center--xs">
                    <figure class="g-display-block--xs g-font-size-70--xs g-font-family--playfair g-color--white g-margin-b-10--xs js__counter">7</figure>
                    <div class="center-block g-hor-divider__solid--white g-width-40--xs g-margin-b-25--xs"></div>
    ...
    <div class="row g-margin-b-30--xs">
        <div class="col-sm-4">
            <div class="g-margin-t-20--md g-margin-b-40--xs">
                ...
                <h2 class="g-font-size-32--xs g-font-size-36--md">Get Free Ticket!</h2>
                ...
                <a href="{{ route('aboutUs') }}" class="text-uppercase s-btn s-btn--xs s-btn--dark-brd g-radius--50 g-padding-x-20--xs g-margin-b-10--xs">Know More</a>
            </div>
        </div>
            ...
            <div id="js__grid-portfolio-gallery" class="s-portfolio__paginations-v1 cbp">
                ...
                <div class="s-portfolio__item cbp-item motion graphic">
                    <div class="s-portfolio__img-effect">
                        <img src="{{ asset('assets/img/970x647/14.jpg')}}" alt="Portfolio Image">
                    </div>
                    <div class="s-portfolio__caption-hover--cc">
                        <div class="g-margin-b-25--xs">
                            <h3 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Vlog</h3>
                            <p class="g-color--white-opacity">Know More</p>
                        </div>
                        <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                            <li>
                                <a href="{{ asset('assets/img/970x647/14.jpg')}}" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by Upside Down BD.">
                                    <i class="ti-fullscreen"></i>
                                </a>
                            </li>
                            <li>
                                <a href="{{url('/promotions')}}" class="s-icon s-icon--sm s-icon s-icon--white-bg g-radius--circle">
                                    <i class="ti-link"></i>
                                </a>
                            </li>
                        </ul>
                ...
                <div class="s-portfolio__item cbp-item logos graphic">
                    <div class="s-portfolio__img-effect">
                        <img src="{{ asset('assets/img/970x647/16.jpg')}}" alt="Portfolio Image">
                    </div>
                    <div class="s-portfolio__caption-hover--cc">
                        <div class="g-margin-b-25--xs">
                            <h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Instagram</h4>
                            <p class="g-color--white-opacity">Know more</p>
                        </div>
                        <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                            <li>
                                <a href="{{ asset('assets/img/970x647/16.jpg')}}" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by Upside Down BD.">
                                    <i class="ti-fullscreen"></i>
                                </a>
                            </li>
                            <li>
                ...
                <div class="s-portfolio__item cbp-item logos motion">
                    <div class="s-portfolio__img-effect">
                        <img src="{{ asset('assets/img/970x647/17.jpg')}}" alt="Portfolio Image">
                    </div>
                    <div class="s-portfolio__caption-hover--cc">
                        <div class="g-margin-b-25--xs">
                        ...
                        <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                            <li>
                                <a href="{{ asset('assets/img/970x647/17.jpg')}}" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by Upside Down BD.">
                                    <i class="ti-fullscreen"></i>
                                </a>
                            </li>
                            <li>
                ...
                <div class="s-portfolio__item cbp-item graphic">
                    <div class="s-portfolio__img-effect">
                        <img src="{{ asset('assets/img/970x647/15.jpg')}}" alt="Portfolio Image">
                    </div>
                    <div class="s-portfolio__caption-hover--cc">
                        <div class="g-margin-b-25--xs">
                            <h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Tik Tok</h4>
                            <p class="g-color--white-opacity">Know more</p>
                        </div>
                        <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                            <li>
                                <a href="{{ asset('assets/img/970x647/15.jpg')}}" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by Upside Down BD.">
                                    <i class="ti-fullscreen"></i>
                                </a>
                            </li>
                            <li>
                ...
                <div class="s-portfolio__item cbp-item logos">
                    <div class="s-portfolio__img-effect">
                        <img src="{{ asset('assets/img/970x647/12.jpg')}}" alt="Portfolio Image">
                    </div>
                    <div class="s-portfolio__caption-hover--cc">
                        <div class="g-margin-b-25--xs">
                            <h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Branding</h4>
                            <p class="g-color--white-opacity">Know more</p>
                        </div>
                        <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                            <li>
                                <a href="{{ asset('assets/img/970x647/12.jpg')}}" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by Upside Down BD.">
                                    <i class="ti-fullscreen"></i>
                                </a>
                            </li>
                            <li>
                ...
                <div class="s-portfolio__item cbp-item motion graphic">
                    <div class="s-portfolio__img-effect">
                        <img src="{{ asset('assets/img/970x647/18.jpg')}}" alt="Portfolio Image">
                    </div>
                    <div class="s-portfolio__caption-hover--cc">
                        <div class="g-margin-b-25--xs">
                            <h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Facebook</h4>
                            <p class="g-color--white-opacity">Know more</p>
                        </div>
                        <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                            <li>
                                <a href="{{ asset('assets/img/970x647/18.jpg')}}" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by Upside Down BD.">
                                    <i class="ti-fullscreen"></i>
                                </a>
                            </li>
                            <li>
