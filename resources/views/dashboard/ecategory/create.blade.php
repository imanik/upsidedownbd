                ...
                <ol class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('ecategory.index') }}" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">{{ __('Categoryes') }}</a>
                        </div>
                    </li>
...
<div class="px-4 sm:px-6 lg:max-w-7xl lg:mx-auto lg:px-8">
    ...
    <div class="bg-white shadow-md overflow-hidden sm:rounded-lg">
        ...
        <form action="{{ route('ecategory.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
